...
namespace MusicStore.Controllers
{
    public class ArtistController : Controller
    {
      ...
      public IActionResult Index(int ArtistSort=0)
        {
            if (ArtistSort == 2)
                return View(_context.Artists.OrderByDescending(a => a.Name).ToListAsync());
            else if (ArtistSort == 1)
                return View(_context.Artists.OrderBy(a => a.Name).ToListAsync());
            else
                return View(_context.Artists.ToListAsync());
        }
